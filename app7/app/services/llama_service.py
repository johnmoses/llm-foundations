...
"""
    ...
    if not questions:
        raise ValueError("Failed to extract valid JSON quiz questions from model output.")
    ...
    for idx, q in enumerate(questions):
        ...
        if q['correct_answer'] not in q['options']:
            raise ValueError(f"Question at index {idx} has correct_answer not in options.")
